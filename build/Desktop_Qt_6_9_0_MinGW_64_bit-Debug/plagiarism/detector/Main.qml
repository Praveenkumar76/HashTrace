...
Window {
    ...
    SystemPalette { id: palette
        colorGroup: darkMode ? SystemPalette.Active : SystemPalette.Inactive }

    // Dark/light mode toggle
    property bool darkMode: false
    onDarkModeChanged: {
        palette.colorGroup = darkMode ? SystemPalette.Active : SystemPalette.Inactive
    }
    ...
    Component {
        ...
        ColumnLayout {
            id: comparePageRoot
            property alias fileCard1: fileCard1  // Expose to parent scope
            property alias fileCard2: fileCard2  // Expose to parent scope
            spacing: 20
            anchors.margins: 10
    ...
    FileDialog {
        ...
        onAccepted: {
            ...
            if (urls.length >= 2) {
                // Access through StackView's currentItem
                stackView.currentItem.fileCard1.filePath = urls[0];
                stackView.currentItem.fileCard2.filePath = urls[1];
